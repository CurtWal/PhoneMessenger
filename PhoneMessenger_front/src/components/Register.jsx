  ...
  return (
    <div className='dark:text-white p-4 max-w-md mx-auto mt-10 border rounded bg-white dark:bg-gray-800'>
      <form onSubmit={handleRegister} className=' flex flex-col gap-4'>
        <h2 className='text-gray-900 dark:text-white text-2xl font-semibold'>Register</h2>
        <div className='flex flex-col gap-4'>
          <div className='flex flex-col'>
            <label className='flex justify-start text-gray-900 dark:text-white'>Name:</label>
            <input className="bg-gray-300 text-black" type="text" name="name" required />
          </div>
          <div className='flex flex-col'>
            <label className='flex justify-start text-gray-900 dark:text-white'>Email:</label>
            <input className="bg-gray-300 text-black" type="email" name="email" required />
          </div>
          <div className='flex flex-col'>
            <label className='flex justify-start text-gray-900 dark:text-white'>Password:</label>
